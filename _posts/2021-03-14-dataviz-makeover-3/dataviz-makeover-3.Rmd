...
- Drag [EVENT_DATE] from left data pane to the Filters shelf and select range of dates in the popup “Filter Field” dialog box. In the popup “Filter” dialog box, click OK <br>
![](images/3.4.png){width=90%}
- Toggle to [EVENT_DATE] under Filter shelf and click on the dropdown button to the right of the pill. Select Show Filter <br>
![](images/3.5.png){width=30%}
-	Toggle again to [EVENT_DATE] under Filter shelf and click on the dropdown button to the right of the pill. Select Apply to Worksheets > All Using This Data Source to apply the filter to all the worksheets <br>
...
- Rename the title of the EVENT_DATE Filter to proper case and replacing hyphen with space by clicking on the dropdown button at the top right of the COUNTRY Filter and select Edit Title. Repeat for the COUNTRY Filter and the EVENT_TYPE Legend <br>
...
-	On the “Point Map” sheet, drag [COUNTRY], [LOCATION], [SUB_EVENT_TYPE] and [FATALITIES] from the left Data pane to Tooltip under the Marks cart <br>
![](images/4.1.png){width=30%}
...
- Right click on the y-axis and select Edit Axis. In the popup “Edit Axis” dialog box, change the Title under Axis Titles to “Number of Events” <br>
