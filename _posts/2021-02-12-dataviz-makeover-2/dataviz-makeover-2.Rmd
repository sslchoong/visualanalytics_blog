...
- Toggle to the pill of [Household Size] under the left Data pane and click on the dropdown button to the right of the pill. Select Convert to Dimension as aliases can only be added for categorical data <br>
...
-	Click on Sheet 2 to add a new worksheet
